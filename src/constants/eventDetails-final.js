export const competitions = [
  ...
  // {
  //   "Event Name":
  //     "Vernacular BuildingStyle and Earthquake Prone Areas with specialReference to Kashmir",
  //   Description:
  ...
  },
  {
    ...
    "Rules": "Entry Requirements: Open to all students, loop station players, or DJs, regardless of experience.\nCompetition Format: Participants must prepare their complete melody using DAW software only—no instruments allowed.\nTrack Requirements: Tracks must be 2-5 minutes long, using only royalty-free or original elements.\nCode of Conduct: All submissions must be original; plagiarism will lead to disqualification.",
    "Prizes": "1000",
    "NIT Entry Fee": "",
    "Outside Entry Fee": "99",
    "Lead Name": "KUNDAN SINGH",
    "Lead Contact Number": 9797985688,
    "Judging Criteria": "Tracks will be judged on creativity, originality, production quality, arrangement, and adherence to the theme.",
    "Start Time": "02:00 PM",
    "End Time": "03:30 PM",
    "Day": 2,
    "Venue": "L 10",
    "Card Image": "Sonic_Showdown.png"
  },
  {
    ...
    "Rules": "-Performance and Participation: Each performance should be between 5-8 minutes. Teams must consist of 5 to 10 members.\n-Choreography and Music: Performances should be based on the UV Dance theme. Only background music is allowed, with no live vocals.\n-Safety: Ensure that movements and props are safe for participants and the audience. Avoid actions that could result in injury.\n-Props: Teams must bring their props. Props should not obstruct the performance space or compromise safety.",
    "Prizes": "2500",
    "NIT Entry Fee": "",
    "Outside Entry Fee": "149",
    "Lead Name": "Janvi",
    "Lead Contact Number": 9699408586,
    "Judging Criteria": "Judging Criteria: Be aware of the judging criteria, which may include elements like creativity, technical skill, use of props, synchronization, and overall presentation.",
    "Start Time": "06:00 PM",
    "End Time": "08:00 PM",
    "Day": 1,
    "Venue": "Main Stage",
    "Card Image": "UV_Dance.png"
  },
  {
  ...
  //   Description:
  //     "At the end of the workshop, students will have gained a foundational \nunderstanding of microcontrollers and hands-on experience with Arduino Uno. \nThey will have successfully completed basic electronics projects, both \nphysically and through simulation on Tinkercad. The workshop will conclude \nwith a brief Q&A session, providing participants the opportunity to clarify any \ndoubts and discuss potential next steps in their learning journey.",
  //   Rules:
  //     "1. Welcome & Introduction (15 mins): Overview of workshop objectives.\n2. Basics of Microcontrollers & Arduino Uno (30 mins): Introduction to microcontrollers \nand Arduino Uno.\n3. Setup & Environment (20 mins): Install Arduino IDE, connect Arduino Uno, and run a \nsimple program.\n4. Live Demonstration (45 mins): Show basic projects (e.g., blinking LED, sensor \nreading).\n5. Tinkercad Simulation (30 mins): Introduction to Tinkercad, simulate Arduino projects.\n6. Hands-on Session (45 mins): Participants build a mini-project with guidance.\n7. Q&A & Wrap-Up (15 mins): Answer questions, recap, and provide further resources.",
  //   Prizes: "",
  //   "NIT Entry Fee": "",
  //   "Outside Entry Fee": "",
