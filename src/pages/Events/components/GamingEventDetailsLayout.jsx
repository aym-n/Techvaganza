  ...
  return (
    <PageLayout title={data["Event Name"]} imgUrl={`/events/${data["Cover Image"]}`}>
      <div className="px-4 md:px-12 py-4 md:py-12 font-playfair bg-background ShadowLarge">
        ...
        <h1 className="entry-header text-3xl font-semibold text-gray-600 font-figtree textShadow-sm mb-4 mt-4 mx-2 leading-normal">Rules</h1>
            ...
            <h1 className="entry-header text-3xl font-semibold text-gray-600 font-figtree textShadow-sm mb-4 mt-4 mx-2 leading-normal">Prizes</h1>
            <div className="space-y-5 mx-4 font-semibold font-kodeMono">
