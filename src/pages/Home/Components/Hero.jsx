  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-20">
        ...
        <div className="pt-4 md:pt-32 py-7 md:p-32">
          {/* <div
            data-aos="fade-down"
          ...
          <div className="font-figtree opacity-60 mt-80 md:mt-72 flex justify-center ">
            <div className="w-full min-w-150 mt-7 px-12 lg:px-40 flex flex-wrap gap-6 justify-between text-white font-bold overflow-hidden">
              ...
              >
                <div className="block text-xl md:text-6xl font-semibold overflow-visible">
                  {timeLeft.days}
                </div>
                <div className=" block text-sm md:text-3xl overflow-visible textShadow-sm">
                  DAYS
                </div>
              </div>
              <div
